...
#include "Graphics/API/Common/TBackend.h"
#include <string>
#include <cstdint>
...
namespace VyEngine::GFX::API
{
    class GLBackend
    {
        ...
        void SetRasterizationMode(GLenum rasterizationMode);
        ...
        void SetDepthAlgorithm(GLenum algorithm);
		...
		void SetStencilOperations(GLenum stencilFail, GLenum depthFail, GLenum bothPass);
